...
#y값 관측.    y의 shape를 기록해주세요.     :   array([0, 1, 2]), array([50, 50, 50]    -> 이진분류 -> 원핫인코딩
y = get_dummies(y)
#print(y.shape)  # (150, 3)
...
model.fit(x_train,y_train, epochs=10000, batch_size=1,validation_split=0.2,verbose=1,callbacks=[es])        # batch_size 센스껏 조절!  
